...
<table className="table">
  ...
  <div className="">
    ...
    <button className="btn btn-outline-danger float-right" height="100px" onClick = {()=>navigate('/admin/customer')}>Edit</button>
    </div>
...
<td>
  ...
  <div className="">
    ...
    <button className="btn btn-outline-warning float-right" height="100px" onClick = {()=>navigate('/admin/employee')}>Edit</button>
    </div>
  <div className="card-body pd-5">
...
<td>
  ...
  <div className="">
    ...
    <button className="btn btn-outline-warning float-right" height="100px" onClick = {()=>navigate('/admin/branch')}>Edit</button>
    </div>
  <div className="card-body pd-5">
