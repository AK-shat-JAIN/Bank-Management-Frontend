    ...
    return(
      ...
      <table className="table">
        ...
        <div className="">
          ...
          <button className="btn btn-outline-success float-right" height="100px" onClick = {()=>navigate('/customer/login')}>Login</button>
          </div>
      ...
      <td>
        ...
        <div className="">
          ...
          <button className="btn btn-outline-success float-right" height="100px" onClick = {()=>navigate('/employee/login')}>Login</button>
          </div>
        <div className="card-body pd-5">
