...
<button className="btn btn-outline-primary ml-3" type="button" data-toggle="collapse" data-target="#AccountDetails" aria-expanded="false" aria-controls="collapseExample" onClick={GetAccountDetails}>
    Get Account Details
  </button>

  <button className="btn btn-success ml-3" onClick={GetTransactions} type="button" data-toggle="collapse" data-target="#alltransaction" aria-expanded="false" aria-controls="collapseExample">
    View Transactions
  </button>
